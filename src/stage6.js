      ...
      <div className="App" >
        ...
        >
          ...
          <Grid container item xs={3} spacing={0} >
            <Box border={1} borderColor="red" style={styles.cell}> 6 <br /> <div onClick={() => this.props.prev()}> prev </div> </Box>
          </Grid>
          <Grid container item xs={3} spacing={0} >
          ...
          <Grid container item xs={3} spacing={0} >
            <Box border={1} borderColor="red" style={styles.cell}> {this.state.clock} <br /> <div style={styles.next}> You Win! </div> </Box>
          </Grid>
