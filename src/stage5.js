      ...
      <div className="App">
        ...
        <Grid container item xs={3} spacing={0} >
          <div style={styles.cell}>
            {" "}
            <div style={styles.frame1}> <span style={styles.frametext} onClick={() => this.props.prev()} ontouchend={() => this.props.prev()}>Level <br /><h1>5</h1></span></div> <br />
            {" "}
          </div>
        </Grid>
        <Grid container item xs={3} spacing={0} >
